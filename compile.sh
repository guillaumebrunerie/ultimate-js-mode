...
cd $ROOT/tree-sitter-javascript && npx tree-sitter generate --abi 13
...
cd $ROOT/tree-sitter-typescript/typescript && npx tree-sitter generate --abi 13
...
cd $ROOT/tree-sitter-typescript/tsx && npx tree-sitter generate --abi 13
